...
import 'package:nak_app/screens/directory/directory_model.dart' as dir_db;
import 'package:nak_app/screens/register/register_model.dart' as reg_db;
  ...
  Future signUp() async {
    if (passwordConfirmed()) {
      try {
        ...
        // add brother to directory
        Map data = {
          'name': '${_firstNameCtrl.text.trim()} ${_lastNameCtrl.text.trim()}',
          'className': _classCtrl.text.trim(),
          'lineNumber': _lineNumberCtrl.text.trim(),
          'modifiedBy': {
            'modifiedBy': '${_firstNameCtrl.text.trim()} ${_lastNameCtrl.text.trim()}',
            'modifiedDate': DateFormat('yMMMd').format(DateTime.now()).toString(),
            'uid': FirebaseAuth.instance.currentUser!.uid,
          }
        };
        String chapterID = reg_db.Registration().chapterNumberID(chapter: _chapterCtrl.text.trim());
        dir_db.Directory().addBrother(data, chapterID);
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text('Now you can register with ANY email!', textAlign: TextAlign.center, style: theme.TextThemes.loginHeadline(context)),
              Padding(
              ...
              Padding(
                ...
                child: TextFormField(
                  decoration: const InputDecoration(
                    ...
                    helperText: '*required - request from your chapter or NEB',
                  ),
