      ...
      body: Padding(
        ...
        child: ListView(
          children: <Widget>[
            ...
            // Chapter Identification Cotainer
            // Flexible(
            //   flex: 1,
            //   fit: FlexFit.loose,
            //   child: Container(
            ...
            //                 Text('Data Container', style: theme.TextThemes.idBody(context),),
            //                 const Spacer(),
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          const Spacer(),
                          Text('Email', style: theme.TextThemes.idLabel(context),),
                          Text('sandro.aguilar@nakinc.org', style: theme.TextThemes.idBody(context),),
                        ],
                      ),
                    )
                  ),
