...
// class EventsChatRoom extends StatefulWidget {
//   const EventsChatRoom({super.key});
//   @override
//   State<EventsChatRoom> createState() => _EventsChatRoomState();
// }

// class _EventsChatRoomState extends State<EventsChatRoom> {
//   final Stream<QuerySnapshot> _stream = FirebaseFirestore.instance.collection('chat').snapshots();

//   // form key
//   final _eventlChatKey = GlobalKey<FormState>();
...
//   void buttonStuff() {
//     if (_eventlChatKey.currentState!.validate()) {
//       // get reference
//       final ref = FirebaseFirestore.instance.collection('chat').doc('events_chat');
...
//       appBar: AppBar(
//         centerTitle: true,
//         title: Text('Upcoming Events Chat', style: theme.TextThemes.headlineMed(context),),
