...
//   // form key
//   final _generalChatKey = GlobalKey<FormState>();
...
//   void buttonStuff() {
//     if (_generalChatKey.currentState!.validate()) {
//       // get reference
...
//       appBar: AppBar(
//         centerTitle: true,
//         title: Text('General Chat', style: theme.TextThemes.headlineMed(context),),
...
//                   if (snapshot.hasData) {
//                     try {
//                       int chatLength = snapshot.data.docs.toList()[1]['active'].length;
//                       List chatList = snapshot.data.docs.toList()[1]['active'];
