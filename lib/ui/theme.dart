...
const Color redOragenClr = Color.fromARGB(255, 241, 70, 40);
...
const Color glowWhiteUI = Color.fromARGB(200, 255, 255, 255);
const Color uiGrey = Color.fromARGB(255, 248, 248, 248);
const Color greyUI = Color.fromARGB(255, 56, 61, 67);
const Color karmaGreyUI = Color.fromARGB(255, 110, 118, 120);
