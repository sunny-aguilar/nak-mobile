...
const policyTxt = [
  ...
  },
  {
    ...
    'paragraphs': [
      ...
      'Active Minds is an organization that focuses on changing the way we talk  about and view mental health. Active Minds provide resources on how to reduce the stigma associated with mental illness and how to discuss mental health challenges',
      'Trevor Project',
      'Phone Number:1-866-488-7386',
      'Website: https://www.thetrevorproject.org',
      'The Trevor Project is an organization that focuses on providing support and resources to LGBT individuals. One of their biggest resources include a 24/7 crisis hotline for individuals who are in crisis, feeling suicidal or need a confidential and judgment free space to voice their concerns.',
      'National Alliance on Mental Illness (NAMI)',
      'Help Line: 800-950-6264',
      'Website: https://www.nami.org/',
      'NAMI is an organization that focuses on improving the mental health of individuals by providing education, support and by advocating for positive mental health changes.',
      'JED Foundation',
      'Phone Number: 1-800-273-8255',
      'Website: https://www.jedfoundation.org',
      'The JED Foundation is an organization that uses education and public outreach as a way of protecting the emotional and health of young adults. In addition to this, the foundation also makes efforts to increase suicide prevention.',
      'American Foundation for Suicide Prevention (AFSP)',
      'Website: https://afsp.org',
      'The AFSP works to improve the way we discuss suicide and suicide prevention. Their goal is to educate individuals about the signs of suicide and look for better ways to prevent suicide from occurring.',
      'Substance Abuse and Mental Health Services Administration (SAMHSA)',
      'Phone number: 1-877-726-4727',
      'Website: https://www.samhsa.gov',
      'SAMHSA works to provide resources and education around substance abuse struggles. While their work is aimed primarily aimed at substance abuse, they also offer resources on suicide prevention and living with mental illness.',
      'National Eating Disorders Association (NEDA)',
      'Phone Number: 1-800-931-2237',
      'Website: https://www.nationaleatingdisorders.org/contact-us',
      'NEDA focuses on the education and prevention of eating disorders and offers support for individuals and their families who are affected by these disorders.',
      'Each Mind Matters/ Sana Mente',
      'Website: https://www.eachmindmatters.org',
      'Each Mind Matters is an organization that focuses on advancing the way California deals with mental health. Sana Mente is an initiative to provide greater mental health education to Spanish Speaking communities and to work to de-stigmatize mental health within these communities.',
    ],
  },
  {
    'title': 'Sexual Assault Prevention Resources',
    'overview': 'Overview',
    'header': 'Sexual Assault Prevention Resources',
    'summary': '',
    'paragraphs': [
      'National Sexual Assault Hotline',
      'Phone Number: 1-800-656-4673 (1-800-756 Hope)',
      'Website: https://rb.gy/dfmocq',
      '24/7 confidential and free resource, that is also available for online communication. This hotline offers resources, referrals, options and support to survivors of sexual assault. It is run by trained specialists who are ready to help.',
      'Victim Connect Resource Center',
      'Phone number: 855-484-2846 (858-4-Victim)',
      'Website: https://rb.gy/kzx2vp',
      'Offers education on what sexual assault is, what consent is, and what you can do if you are a victim of sexual assault and violence. They also can connect you with local specialists who are better equipped to help. This is a great website for anyone beginning their journey as an ally to a survivor and the resources are available in Spanish as well.',
      'Male Survivor',
      'Website: https://malesurvivor.org/',
      'Male survivor focuses on supporting male identified survivors of sexual assault and sexual violence. Right now the current statistic is 1in 6 men is a survivor of sexual assault. They connect you with other survivors, offer education, host events that focus on healing and education. They offer information about the research being done on sexual trauma and can help you find a therapist.',
      '1 in 6',
      'Website: https://1in6.org/about-1in6/',
      'Focuses on Male survivors and focuses on helping survivors live happier and healthier lives. This includes access to a 24/7 health line, access to information and resources and trauma based therapy that are held through online webinars. Most importantly their approach includes a cultural component, their approach is defined as an intersectional approach.',
      'National Violence Resource Center',
      'Website: https://www.nsvrc.org/',
      'Focuses on supporting survivors who have survived sexual violence, as well as loved ones, advocates and educators and the press and media. They offer information on: research, events, statistics and ways to support a survivor of sexual violence. They connect individuals to a variety of resources and pages that can offer the support they are looking for.',
      'SAVE — Stop Abusive and Violent Environments',
      'Website: https://www.saveservices.org/',
      'Provides resources for victims, survivors, and the accused. Resources include is on due process, Title IX procedures, impartial and fair investigations, legislative action, and other links to foster a holistic approach to resolving related issues.',
    ],
  },
  {
    'title': 'Campus Title IX Resources',
    'overview': 'Overview',
    'header': 'Campus Title IX Resources',
    'summary': 'Know Your Rights: Title IX Prohibits Sexual Harassment and Sexual Violence Where You Go to School.',
    'paragraphs': [
      'US Department of Education – Office of Civil Rights – Title IX https://www2.ed.gov/about/offices/list/ocr/docs/title-ix-rights-201104.html',
      'Culture of Respect – End sexual violence through ongoing, expansive organizational change https://cultureofrespect.org/',
    ],
  },
];

// EMAIL FORM TEXT
String confidentiality = '<p>--</p>'
  '<p>This e-mail was sent from the INCIDENT RESPONSE FORM from the NAK App.</p>'
